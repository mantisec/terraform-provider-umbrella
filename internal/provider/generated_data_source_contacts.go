...
func init() {
	RegisterGeneratedDataSource(NewContactsDataSource)
}

// ContactsDataSource implements the contacts data source
type ContactsDataSource struct {
	client *apiClient
}

// contactsDataModel represents the data source data model
type contactsDataModel struct {
	Id types.String `tfsdk:"id"`
}

// NewContactsDataSource creates a new contacts data source
...
func (d *ContactsDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		Description: "contacts data source",
