...
func (r *TrialextensionsResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	if err != nil {
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to create trialextensions, got error: %s", err))
		return
	}
...
func (r *TrialextensionsResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	resp.Diagnostics.AddError("Configuration Error", "No update endpoint configured for trialextensions")
	return
...
func (r *TrialextensionsResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	resp.Diagnostics.AddError("Configuration Error", "No delete endpoint configured for trialextensions")
}
