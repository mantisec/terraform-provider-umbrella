...
func init() {
	RegisterGeneratedResource(NewCreatecontactResource)
}

// CreatecontactResource implements the createcontact resource
type CreatecontactResource struct {
	client *apiClient
}

// createcontactModel represents the resource data model
...
// NewCreatecontactResource creates a new createcontact resource
func NewCreatecontactResource() resource.Resource {
	return &CreatecontactResource{}
}

// Metadata returns the resource type name
func (r *CreatecontactResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = "umbrella_createcontact"
}

// Configure configures the resource with the provider client
func (r *CreatecontactResource) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *CreatecontactResource) Schema(_ context.Context, _ resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{
		Description: "createcontact resource",
...
// Create creates a new createcontact
func (r *CreatecontactResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var plan createcontactModel
	...
	// Make API call
	result, err := r.client.CreateResource(ctx, "/config/contacts", requestBody)
	if err != nil {
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to create createcontact, got error: %s", err))
		return
	}
...
// Read reads the createcontact
func (r *CreatecontactResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state createcontactModel
...
// Update updates the createcontact
func (r *CreatecontactResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var plan createcontactModel
	resp.Diagnostics.Append(req.Plan.Get(ctx, &plan)...)
	if resp.Diagnostics.HasError() {
		return
	...
	resp.Diagnostics.AddError("Configuration Error", "No update endpoint configured for createcontact")
	return

	resp.Diagnostics.Append(resp.State.Set(ctx, plan)...)
}

// Delete deletes the createcontact
func (r *CreatecontactResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var state createcontactModel
	resp.Diagnostics.Append(req.State.Get(ctx, &state)...)
	if resp.Diagnostics.HasError() {
		return
	...
	resp.Diagnostics.AddError("Configuration Error", "No delete endpoint configured for createcontact")
}
