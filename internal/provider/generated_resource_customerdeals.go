...
func (r *CustomerdealsResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	resp.Diagnostics.AddError("Configuration Error", "No create endpoint configured for customerdeals")
	return
...
func (r *CustomerdealsResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	if err != nil {
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to update customerdeals, got error: %s", err))
		return
	}
...
func (r *CustomerdealsResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	resp.Diagnostics.AddError("Configuration Error", "No delete endpoint configured for customerdeals")
}
