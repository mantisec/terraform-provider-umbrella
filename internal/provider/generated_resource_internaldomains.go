...
func init() {
	RegisterGeneratedResource(NewInternaldomainsResource)
}
...
func (r *InternaldomainsResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	if err != nil {
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to create internaldomains, got error: %s", err))
		return
	}
...
// Read reads the internaldomains
...
func (r *InternaldomainsResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	if err != nil {
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to update internaldomains, got error: %s", err))
		return
	}
...
func (r *InternaldomainsResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	if err != nil {
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to delete internaldomains, got error: %s", err))
		return
	}
}
