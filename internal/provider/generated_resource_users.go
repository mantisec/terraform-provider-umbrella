...
func init() {
	RegisterGeneratedResource(NewUsersResource)
}
...
func (r *UsersResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	if err != nil {
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to create users, got error: %s", err))
		return
	}
...
func (r *UsersResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	resp.Diagnostics.AddError("Configuration Error", "No update endpoint configured for users")
	return
...
func (r *UsersResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	if err != nil {
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to delete users, got error: %s", err))
		return
	}
}
