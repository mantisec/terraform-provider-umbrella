...
func init() {
	RegisterGeneratedResource(NewCreateprovidercustomerResource)
}

// CreateprovidercustomerResource implements the createprovidercustomer resource
type CreateprovidercustomerResource struct {
	client *apiClient
}

// createprovidercustomerModel represents the resource data model
type createprovidercustomerModel struct {
...
// NewCreateprovidercustomerResource creates a new createprovidercustomer resource
func NewCreateprovidercustomerResource() resource.Resource {
	return &CreateprovidercustomerResource{}
}

// Metadata returns the resource type name
func (r *CreateprovidercustomerResource) Metadata(_ context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = "umbrella_createprovidercustomer"
}

// Configure configures the resource with the provider client
func (r *CreateprovidercustomerResource) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *CreateprovidercustomerResource) Schema(_ context.Context, _ resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{
		Description: "createprovidercustomer resource",
...
// Create creates a new createprovidercustomer
func (r *CreateprovidercustomerResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var plan createprovidercustomerModel
	...
	// Make API call
	result, err := r.client.CreateResource(ctx, "/providers/customers", requestBody)
	if err != nil {
		resp.Diagnostics.AddError("Client Error", fmt.Sprintf("Unable to create createprovidercustomer, got error: %s", err))
		return
	}
...
// Read reads the createprovidercustomer
func (r *CreateprovidercustomerResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state createprovidercustomerModel
...
// Update updates the createprovidercustomer
func (r *CreateprovidercustomerResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var plan createprovidercustomerModel
	resp.Diagnostics.Append(req.Plan.Get(ctx, &plan)...)
	if resp.Diagnostics.HasError() {
		return
	...
	resp.Diagnostics.AddError("Configuration Error", "No update endpoint configured for createprovidercustomer")
	return

	resp.Diagnostics.Append(resp.State.Set(ctx, plan)...)
}

// Delete deletes the createprovidercustomer
func (r *CreateprovidercustomerResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var state createprovidercustomerModel
	resp.Diagnostics.Append(req.State.Get(ctx, &state)...)
	if resp.Diagnostics.HasError() {
		return
	...
	resp.Diagnostics.AddError("Configuration Error", "No delete endpoint configured for createprovidercustomer")
}
