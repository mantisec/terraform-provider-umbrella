...
func init() {
	RegisterGeneratedDataSource(NewRequestsDataSource)
}

// RequestsDataSource implements the requests data source
type RequestsDataSource struct {
	client *apiClient
}

// requestsDataModel represents the data source data model
type requestsDataModel struct {
	Id types.String `tfsdk:"id"`
}

// NewRequestsDataSource creates a new requests data source
...
func (d *RequestsDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = "umbrella_requests"
}
...
func (d *RequestsDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		Description: "requests data source",
