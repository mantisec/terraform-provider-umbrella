...
- `generated_resource_destination_list.go` - Destination list Terraform resource
- `generated_data_source_destination_list.go` - Destination list data source
- `generated_resource_internal_network.go` - Internal networks Terraform resource
- `generated_data_source_internal_network.go` - Internal networks data source
